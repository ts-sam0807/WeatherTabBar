...
class CityViewController: UIViewController {
  ...
  @objc func showWeatherDetails() {
    ...
    detailsVC.countryNameLabel.text = city.flag
    detailsVC.cityNameLabel.text = city.name
    detailsVC.temperatureValueLabel.text = String(city.temp)
    detailsVC.summaryValueLabel.text = city.summary
